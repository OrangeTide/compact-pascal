...
The general point is that a design document written before a feature lands has to be re-read after it lands, and re-read against the code rather than against memory of the code. Nothing in Phase M looked like it touched separate compilation.
